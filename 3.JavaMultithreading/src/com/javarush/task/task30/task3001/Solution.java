...
//            Integer
//            long aLong = Long.parseLong(number.getDigit(), number.getNumerationSystem().getNumerationSystemIntValue());
//            return new Number(expectedNumerationSystem, Long.toString(aLong, expectedNumerationSystem.getNumerationSystemIntValue()));
//
