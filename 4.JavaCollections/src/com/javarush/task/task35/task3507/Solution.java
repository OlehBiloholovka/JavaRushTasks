...
//        ClassLoader classLoader = new ClassPathLoader(new ClassPath(pathToAnimals));
////        classLoader.
...
//        ClassLoader loader = new ClassPathLoader(new ClassPath(pathToAnimals));
//        File dir = new File(pathToAnimals);
//        String[] modules =  dir.list();
//        for (String module : modules) {
//            String className = module.split(".class")[0];
//            try {
//                Class clazz = loader.loadClass(className);
//                if (Arrays.asList(clazz.getInterfaces()).contains(Animal.class) && clazz.getConstructor(.)){
